...
def main():
    ...
    output_dir = 'segmentation_v2_output'
    segment_dir = 'segmentation_v2_masks'
    masked_output_dir = 'segmentation_v2_masked_images'
    ...
    for image_file in image_files:
        try:
            ...
            mask_path = os.path.join(segment_dir, f"{title}_segmented.png")
